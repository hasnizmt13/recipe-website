...
class newspage
{
    ...
    public function news(){
       ?>
       <div>
            <img style="width:100%" src="./Outils/banner.jpeg" alt="">
       </div>
       <?php 
       $controller = new userController();
        $res = $controller->getNewsID($_GET['id']);
         foreach ($res as $row) {
             ?>
            <div class="carte" style="width: 64%;margin: 10px 18%;">
                    <img style="width: 60%;margin: auto;" src="/WEB/Outils/images/<?php  echo $row["image"]; ?>" alt="">
            </div>
